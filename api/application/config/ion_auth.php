 ...
 */
$config['site_title']                 = "DollarGifts";       // Site Title, example.com
$config['admin_email']                = "admin@dollargifts.org"; // Admin Email, admin@example.com
...
$config['user_expire']                = 865000;               // How long to remember the user (seconds). Set to zero for no expiration
...
$config['forgot_password_expiration'] = 720000;                   // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
